    ...
    return (
        <div className="menu-wrapper" role="navigation">
            <ul className="nav" role="menubar" id="header-nav-menubar">
                ...
                <li role="menuitem" id="header-menuitem-popular"
                    onMouseEnter={() => {
                        document.getElementById("header-menuitem-popular").classList.add('animate__animated');
                    }}
                    onMouseLeave={() => {
                        document.getElementById("header-menuitem-popular").classList.remove('animate__animated');
                    }}
                >
                    <Link href="/popular">
                        <a>Popular</a>
                ...
                <li role="menuitem" id="header-menuitem-custom-page"
                    onMouseEnter={() => {
                        document.getElementById("header-menuitem-custom-page").classList.add('animate__animated');
                    }}
                    onMouseLeave={() => {
                        document.getElementById("header-menuitem-custom-page").classList.remove('animate__animated');
                    }}
                >
